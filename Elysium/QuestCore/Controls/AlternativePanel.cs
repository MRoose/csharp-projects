...
namespace QuestCore
{
    public partial class AlternativePanel : UserControl
    {
        ...
        public void Build(Questionnaire questionnaire, Quest quest, Alternative alt)
        {
            ...
            lbCondition.Text = alt.Condition?.ToString() ?? "Задать зависимость";
        ...
        {
            if (MessageBox.Show("Удалить вариант?", "Удаление варианта", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
